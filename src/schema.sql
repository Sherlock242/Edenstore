...
--
-- Policies for 'products' and related tables
--
...
create policy "Allow authenticated users to manage product sizes" on product_sizes
  for all to authenticated
  using (true)
  with check (true);
  
create policy "Allow authenticated users to manage product colors" on product_colors
  for all to authenticated
  using (true)
  with check (true);
